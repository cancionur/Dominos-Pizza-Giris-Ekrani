...
class GelAlTekKisilik extends StatefulWidget {
  const GelAlTekKisilik({Key? key}) : super(key: key);

  @override
  State<GelAlTekKisilik> createState() => _GelAlTekKisilikState();
}

class _GelAlTekKisilikState extends State<GelAlTekKisilik> {

  var m1 = MenuSecenegi("tekkisilikpizzacola.jpg", "Gel Al - Orta Boy Pizza\n + Coca-Cola Kutu 330 mL", "61.99");
  var m2 = MenuSecenegi("ortaboypaketos.jpg", "Gel - Al Orta Boy\n Paketos", "66.99");
