...
class GelAlDortKisilik extends StatefulWidget {
  const GelAlDortKisilik({Key? key}) : super(key: key);

  @override
  State<GelAlDortKisilik> createState() => _GelAlDortKisilikState();
}

class _GelAlDortKisilikState extends State<GelAlDortKisilik> {
